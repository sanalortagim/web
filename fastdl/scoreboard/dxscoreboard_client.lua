						...
						if content then
							...
							elseif column.name == "country" then	
								...
								if fileExists(countryImage) then
									dxDrawImage(topX+theX,y+((1*dxGetFontHeight( fontscale(contentFont, scoreboardScale), contentFont ))/2)-(11/2),16,11,countryImage)
									dxDrawText( string.gsub(content,"#%x%x%x%x%x%x",""), topX+10+theX+s(1)+s(10), 	y+s(1), topX+x+s(1+column.width), 	y+s(1)+(1*dxGetFontHeight( fontscale(contentFont, scoreboardScale), contentFont )), 	tocolor( 0, 0, 0, a or 255 ), fontscale(contentFont, s(1)), contentFont, "left", "center", true, false, drawOverGUI )
									dxDrawText(  "#FFFFFF"..content, topX+10+theX+s(10), 		y, 		topX+x+s(column.width), 	y+(1*dxGetFontHeight( fontscale(contentFont, scoreboardScale), contentFont )), 			tocolor( r or 255, g or 255, b or 255, a or 255 ), fontscale(contentFont, s(1)), contentFont, "left", "center", true, false, drawOverGUI,true )
								else
									dxDrawText( string.gsub(content,"#%x%x%x%x%x%x",""), topX+theX+s(1), 	y+s(1), topX+x+s(1+column.width), 	y+s(1)+(1*dxGetFontHeight( fontscale(contentFont, scoreboardScale), contentFont )), 	tocolor( 0, 0, 0, a or 255 ), fontscale(contentFont, s(1)), contentFont, "left", "center", true, false, drawOverGUI )
									dxDrawText(  "#FFFFFF"..content, topX+theX, 		y, 		topX+x+s(column.width), 	y+(1*dxGetFontHeight( fontscale(contentFont, scoreboardScale), contentFont )), 			tocolor( r or 255, g or 255, b or 255, a or 255 ), fontscale(contentFont, s(1)), contentFont, "left", "center", true, false, drawOverGUI,true )
								end
							elseif column.name == "id" then
								if element == localPlayer then
									dxDrawText( string.gsub(content,"#%x%x%x%x%x%x",""), topX+s(1), 	y+s(1), topX+x+s(1+column.width), 	y+s(1)+(1*dxGetFontHeight( fontscale(contentFont, scoreboardScale), contentFont )), 	tocolor( 0, 0, 0, a or 255 ), fontscale(contentFont, s(1)), contentFont, "center", "center", true, false, drawOverGUI )
									dxDrawText( "#FFFFFF"..content, topX, 		y, 		topX+x+s(column.width), 	y+(1*dxGetFontHeight( fontscale(contentFont, scoreboardScale), contentFont )), 			tocolor( r or 255, g or 255, b or 255, a or 255 ), fontscale(contentFont, s(1)), contentFont, "center", "center", true, false, drawOverGUI,true )
								else
									dxDrawText( string.gsub(content,"#%x%x%x%x%x%x",""), topX+s(1), 	y+s(1), topX+x+s(1+column.width), 	y+s(1)+(1*dxGetFontHeight( fontscale(contentFont, scoreboardScale), contentFont )), 	tocolor( 0, 0, 0, a or 255 ), fontscale(contentFont, s(1)), contentFont, "center", "center", true, false, drawOverGUI )
									dxDrawText( "#FFFFFF"..content, topX, 		y, 		topX+x+s(column.width), 	y+(1*dxGetFontHeight( fontscale(contentFont, scoreboardScale), contentFont )), 			tocolor( r or 255, g or 255, b or 255, a or 255 ), fontscale(contentFont, s(1)), contentFont, "center", "center", true, false, drawOverGUI,true )
								end
							elseif column.name == "Fps" then
								local fps = tonumber(content) - 25
								b = 0
								if fps>=25 then r, g = 0, 255
								elseif fps<=0 then r, g = 255, 0
								elseif fps<=12 then
									r = 255
									g = 255 - 255 * (12 - fps) / 12
								else
							...
							elseif column.name == "ping" then
								...
								b = 0
								if ping<=50 then r, g = 0, 255
								elseif ping>350 then r, g = 255, 0
								elseif ping<=200 then
									r = 255 * (ping-50) / 150
									g = 255
								else
									r = 255
									g = 255 - 255 * (ping-200) / 150
								end
								dxDrawText( content, topX+theX+s(1), 	y+s(1), topX+x+s(1+column.width), 	y+s(11)+dxGetFontHeight( fontscale(contentFont, scoreboardScale), contentFont ), 	tocolor( 0, 0, 0, a or 255 ), fontscale(contentFont, s(1)), contentFont, "left", "top", true, false, drawOverGUI )
								dxDrawText( content, topX+theX, 		y, 		topX+x+s(column.width), 	y+dxGetFontHeight( fontscale(contentFont, scoreboardScale), contentFont ), 			tocolor( r or 255, g or 255, b or 255, a or 255 ), fontscale(contentFont, s(1)), contentFont, "left", "top", true, false, drawOverGUI )
							else
								dxDrawText( string.gsub(content,"#%x%x%x%x%x%x",""), topX+theX+s(1), 	y+s(1), topX+x+s(1+column.width), 	y+s(1)+(1*dxGetFontHeight( fontscale(contentFont, scoreboardScale), contentFont )), 	tocolor( 0, 0, 0, a or 255 ), fontscale(contentFont, s(1)), contentFont, "left", "center", true, false, drawOverGUI )
								dxDrawText(  ""..content, topX+theX, 		y, 		topX+x+s(column.width), 	y+(1*dxGetFontHeight( fontscale(contentFont, scoreboardScale), contentFont )), 			tocolor( r or 255, g or 255, b or 255, a or 255 ), fontscale(contentFont, s(1)), contentFont, "left", "center", true, false, drawOverGUI,true )
							end
						end
						x = x + s(column.width + 10)
					end
