...
function readScoreboardSettings()
	...
	showServerInfo = --[[settings.showserverinfo]] true
	showGamemodeInfo = --[[settings.showgamemodeinfo]] true
	...
	cScoreboardBackground = tocolor( 30,30,30,220 )
	cSelection = tocolor( 220,120,0,100 )
	cHighlight = tocolor( settings.highlight_color.r, settings.highlight_color.g, settings.highlight_color.b, settings.highlight_color.a )
	cHeader = tocolor( 220,120,0 )
	cTeam = tocolor( 155,155,155,40 )
	cBorder = tocolor( 100,100,100,80 )
	cServerInfo = tocolor( 255,255,255 )
	cContent = tocolor( settings.content_color.r, settings.content_color.g, settings.content_color.b, settings.content_color.a )
